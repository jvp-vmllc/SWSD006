...
static void radio_mp_to_lr11xx_mp(lr11xx_radio_mod_params_gfsk_t *fsk_mp, const sid_pal_radio_fsk_modulation_params_t *mod_params)
{
    ...
    _Static_assert(SID_PAL_RADIO_FSK_MOD_SHAPING_G_BT_03 == LR11XX_RADIO_GFSK_PULSE_SHAPE_BT_03, "Invalid convertion");
    _Static_assert(SID_PAL_RADIO_FSK_MOD_SHAPING_G_BT_05 == LR11XX_RADIO_GFSK_PULSE_SHAPE_BT_05, "Invalid convertion");
    _Static_assert(SID_PAL_RADIO_FSK_MOD_SHAPING_G_BT_07 == LR11XX_RADIO_GFSK_PULSE_SHAPE_BT_07, "Invalid convertion");
...
static void radio_pp_to_lr11xx_pp(lr11xx_radio_pkt_params_gfsk_t *fsk_pp, const sid_pal_radio_fsk_packet_params_t *packet_params)
{
    ...
    _Static_assert(LR11XX_RADIO_GFSK_PREAMBLE_DETECTOR_OFF        == SID_PAL_RADIO_FSK_PREAMBLE_DETECTOR_OFF, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_PREAMBLE_DETECTOR_MIN_8BITS  == SID_PAL_RADIO_FSK_PREAMBLE_DETECTOR_08_BITS, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_PREAMBLE_DETECTOR_MIN_16BITS == SID_PAL_RADIO_FSK_PREAMBLE_DETECTOR_16_BITS, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_PREAMBLE_DETECTOR_MIN_24BITS == SID_PAL_RADIO_FSK_PREAMBLE_DETECTOR_24_BITS, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_PREAMBLE_DETECTOR_MIN_32BITS == SID_PAL_RADIO_FSK_PREAMBLE_DETECTOR_32_BITS, "Invalid convertion");
    ...
    _Static_assert(LR11XX_RADIO_GFSK_ADDRESS_FILTERING_DISABLE      == SID_PAL_RADIO_FSK_ADDRESSCOMP_FILT_OFF, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_ADDRESS_FILTERING_NODE_ADDRESS == SID_PAL_RADIO_FSK_ADDRESSCOMP_FILT_NODE, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_ADDRESS_FILTERING_NODE_AND_BROADCAST_ADDRESSES == SID_PAL_RADIO_FSK_ADDRESSCOMP_FILT_NODE_BROAD, "Invalid convertion");
    fsk_pp->address_filtering     = (lr11xx_radio_gfsk_address_filtering_t)packet_params->addr_comp;

    _Static_assert(LR11XX_RADIO_GFSK_PKT_FIX_LEN == SID_PAL_RADIO_FSK_RADIO_PACKET_FIXED_LENGTH, "Invalid convertion");
    _Static_assert(LR11XX_RADIO_GFSK_PKT_VAR_LEN == SID_PAL_RADIO_FSK_RADIO_PACKET_VARIABLE_LENGTH, "Invalid convertion");
...
int32_t radio_fsk_process_rx_done(halo_drv_semtech_ctx_t *drv_ctx, radio_fsk_rx_done_status_t *rx_done_status)
{
    ...
    do {
        ...
        if (lr11xx_regmem_read_buffer8(drv_ctx, buffer, rx_buffer_status.buffer_start_pointer + LR11XX_FSK_PHY_HEADER_LENGTH,
...
{
    if (lr11xx_radio_set_gfsk_sync_word(lr11xx_get_drv_ctx(), sync_word)
        != LR11XX_STATUS_OK) {
